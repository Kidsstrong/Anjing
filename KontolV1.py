            ...
            if msg.contentType == 13:
                if settings["wblack"] == True:
                    if msg.contentMetadata["mid"] in settings["commentBlack"]:
                        nadya.sendMessage(msg.to,"Di Blacklist Anjing")
                    ...
                    if msg.contentMetadata["mid"] in settings["commentBlack"]:
                        ...
                        settings["dblack"] = False
                        nadya.sendMessage(msg.to,"Tidak di Blacklist")
#-------------------------------------------------------------------------------
                elif settings["wblacklist"] == True:
                    if msg.contentMetadata["mid"] in settings["blacklist"]:
                        nadya.sendMessage(msg.to,"Sudah Di Blacklist ")
                    ...
                    if msg._from in Owner:
                        ...
                        for target in targets:
                            try:
                                ...
                                nadya.sendMessage(msg.to,"Owner BOT Kontol\nAdd\nExecuted")
                            except:
                                pass
                    else:
                    ...
                    if msg._from in Owner:
                        ...
                        for target in targets:
                            try:
                                ...
                                f=codecs.open('admin.json','w','utf-8')
                                json.dump(admin, f, sort_keys=True, indent=4,ensure_ascii=False)
                                nadya.sendMessage(msg.to,"Admin BOT Kontol\nRemove\nExecuted")
                                break
                            except:
...
#-------------------------------------------------------------------------------
                    ...
                    if msg._from in Owner:
                        if admin == []:
                            ...
                            nadya.sendMessage(msg.to,"Tunggu Tod ...")
                            mc = "╔═══════════════\n╠BOT KONTOL V.1\n╠══✪〘 Admin List 〙✪═══\n"
                            for mi_d in admin:
                                mc += "╠✪ " +nadya.getContact(mi_d).displayName + "\n"
                            nadya.sendMessage(msg.to,mc + "╠═══════════════\n╠✪〘 line.me/ti/p/~kecapp_ 〙\n╚═══════════════")
...
#-------------------------------------------------------------------------------
                    ...
                    if msg._from in Owner:
                        ...
                        nadya.sendMessage(msg.to,"Just for Kontol")
...
#==============================================================================#
                  ...
                  if msg._from in Owner:    
                    if 'MENTION' in msg.contentMetadata.keys()!= None:
                        ...
                        try:
                            ...
                            nadya.sendMessage(msg.to, "Berhasil clone member! tunggu beberapa saat Jancok")
                        except:
                  ...
                  if msg._from in Owner:    
                    try:
                        ...
                        nadya.sendMessage(msg.to, "Berhasil restore profile! tunggu beberapa saat Jancok")
                    except:
...
#==============================================================================#
                    ...
                    for target in targets:
                        try:
                            ...
                            nadya.sendMessage(msg.to,"Gagal menambahkan Target !")
                            break
                    ...
                    for target in targets:
                        try:
                            ...
                            nadya.sendMessage(msg.to,"Menghapus Target gagal !")
                            break
...
#==============================================================================#
                    ...
                    if msg.toType == 2:
                        ...
                        if group.preventedJoinByTicket == False:
                            ...
                            nadya.sendMessage(to, "Grup qr tidak terbuka Anjing! buka terlebih dahulu dengan perintah {}openqr".format(str(settings["keyCommand"])))
...
#-------------------------------------------------------------------------------
    ...
    #                       nadya.sendMessage(msg.to,"「 Dadah Tod :) 」")
    #                       nadya.sendMessage(msg.to,"「 Sorry Tod :( 」")
                            targets = []
                            for g in gs.members:
...
#===============================================================================[NEW]                    
                ...
                if msg.toType == 2:
                    ...
                    nadya.sendMessage(to, "Berhasil mengundang kedalam freecal group")
...
#===============================================================================[nadyaMID - kiMID]
        if op.type == 19:
            print ("[ 19 ] KICKOUT KONTOL MESSAGE")
            try:
